...
# user1.notebooks.create(title: "Journal", color: "dark-blue")
# user1.notebooks.create(title: "Dreams", color: "dark-red")
# user1.notebooks.create(title: "Work", color: "dark-green")
